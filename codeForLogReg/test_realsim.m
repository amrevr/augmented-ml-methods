%% classification on realsim

t_load_start = tic;
load realsim.mat;
t_load_end = toc(t_load_start);
fprintf('Time taken to load data: %5.4f seconds\n', t_load_end);
...
% xlabel('iteration');
% ylabel('Norm of Grad');
% title('realsim by APG of student');
% set(gca,'fontsize',14)
% print(fig,'-dpdf','realsim_APG_student')
...
xlabel('iteration');
ylabel('Norm of Grad');
title('realsim by L-BFGS of student');
set(gca,'fontsize',14)
print(fig,'-dpdf','realsim_LBFGS_student')
...
% xlabel('iteration');
% ylabel('Norm of Grad');
% title('realsim by APG of instructor');
% set(gca,'fontsize',14)
% print(fig,'-dpdf','realsim_APG_instructor')
...
xlabel('iteration');
ylabel('Norm of Grad');
title('realsim by L-BFGS of instructor');
set(gca,'fontsize',14)
print(fig,'-dpdf','realsim_LBFGS_instructor')
