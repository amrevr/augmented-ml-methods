...
% xlabel('iteration');
% ylabel('Norm of Grad');
% title('rcv1 by APG of student');
% set(gca,'fontsize',14)
% print(fig,'-dpdf','rcv1_APG_student')
...
% xlabel('iteration');
% ylabel('Norm of Grad');
% title('rcv1 by L-BFGS of student');
% set(gca,'fontsize',14)
% print(fig,'-dpdf','rcv1_LBFGS_student')
...
xlabel('iteration');
ylabel('Norm of Grad');
title('rcv1 by APG of instructor');
set(gca,'fontsize',14)
print(fig,'-dpdf','rcv1_APG_instructor')
...
xlabel('iteration');
ylabel('Norm of Grad');
title('rcv1 by L-BFGS of instructor');
set(gca,'fontsize',14)
print(fig,'-dpdf','rcv1_LBFGS_instructor')
